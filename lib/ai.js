...
Normalizza:
- importi come numeri (es. "EUR 1.234,56" -> 1234.56),
...
Sei uno scraper documentale. Questo Ã¨ il testo di una â€œPROPOSTAâ€ compilata dallâ€™agente.
Estrai i campi richiesti e restituisci SOLO JSON conforme allo schema. NON inventare valori: se mancano â†’ null.
Se trovi in fondo al documento le etichette â€œLuogo:â€ e â€œData:â€, estrai:
- luogo_redazione (stringa pulita)
- data_redazione (ISO YYYY-MM-DD)
- anno_redazione (intero, di solito l'anno della data)
Regole: importi numerici; SI/NO in "SI"/"NO"; IBAN accetta solo formati italiani (ITâ€¦); nominativo senza prefissi tipo "Sig.", "/a".
